...
public class TestValues extends BaseParameterizedTest {

    private PHFactory factory;

    public TestValues(int nrServers) throws IOException {
        super(nrServers);
    ...
    public void testQuery() {
        ...
        //extent query
        PVIterator<Integer> i1 = ind.queryExtent();
        int n = 0;
        while (i1.hasNext()) {
            PVEntry<Integer> e = i1.nextEntry();
