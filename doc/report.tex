...
A high level diagram of the client library is presented in Figure \ref{fig:Client-library}. 
\begin{figure}[h]
    \centering 
...
The high level diagram of the server library is presented in Figure \ref{fig:Server-library}
\begin{figure}[h]
    \centering 
